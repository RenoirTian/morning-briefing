...
def generate_html(a, us, gainers, losers, new_stocks, fin_news, tech_news):
    ...
    # Footer
    # Refresh button + toast + script
    h.append('<button class="refresh-btn" id="refreshBtn" title="Refresh data"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"></polyline><polyline points="1 20 1 14 7 14"></polyline><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"></path></svg></button>')
